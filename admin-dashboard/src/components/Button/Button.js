...
const Button = ({children, onClick, type}) => {
  ...
  return (
    <button onClick={onClick} className={`flex items-center justify-center btn ${colorClasses} text-white px-4 py-2 rounded-lg shadow-md transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110`}>
